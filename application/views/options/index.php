	...
	<div class="col-lg-6">
		<fieldset>
 		...
 		<fieldset>
  			...
  			<div class="custom-checkbox">
			    <input <?= (!empty($Option[0]['auto_cus_num']) && $Option[0]['auto_cus_num'] == 1)?'checked':'' ?> type="checkbox" name="txt_cus_auto_num" value="1" id="txt_cus_auto_num">
			    <label for="txt_cus_auto_num" style="font-weight:400;">Auto-assign customer number</label>
			</div>
 		</fieldset>
	</div>
</div>
