                    ...
                    <div class="col-lg-8" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-10 padding_zero">
                                ...
                                <input name="service_address_1_" value="<?php echo !empty($Service[0]['service_address_1'])?$Service[0]['service_address_1']:''; ?>" type="text" class="form-control" placeholder="Address 1" style="margin-top: 5px;">
                                <input name="service_address_2_" value="<?php echo !empty($Service[0]['service_address_2'])?$Service[0]['service_address_2']:''; ?>" type="text" class="form-control" placeholder="Address 2" style="margin-top: 5px;">
                                <div class="form-group" style="margin-top: 5px;margin-bottom: 5px;">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="city_billing_customers">
                                                <input name="service_city_" value="<?php echo !empty($Service[0]['service_city'])?$Service[0]['service_city']:''; ?>" type="text" class="form-control" placeholder="City"> 
                                            </div>
                                            <div class="space_customers">&nbsp;</div>
                                            <div class="state_billing_customers">
                                                <select name="service_state_" class="form-control">
                                            ...
                                            <div class="zip_billing_customers">
                                                <input name="service_zip_" value="<?php echo !empty($Service[0]['service_zip'])?$Service[0]['service_zip']:''; ?>" type="text" class="form-control" placeholder="Zip"> 
                                            </div>
                                            <div class="space_customers">&nbsp;</div>
                        ...
                        <div class=" form-group">
                            ...
                            <div class="col-lg-10 col-md-10 padding_zero">
                                <select name="service_route_" class="form-control" style="margin-top: 5px;">
