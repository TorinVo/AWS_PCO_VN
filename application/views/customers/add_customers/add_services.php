            ...
            <div class="col-lg-8 service_address_<?php echo $index_service; ?>" style="padding-left: 5px;padding-right: 5px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10 padding_zero">
                        <input name="service_address_name_<?php echo $index_service; ?>" type="text" class="form-control" placeholder="Blling Name - Leave blank if same as customer name">
                        <input name="service_atn_<?php echo $index_service; ?>" type="text" class="form-control" placeholder="Attn" style="margin-top: 5px;">
                        <input name="service_address_1_<?php echo $index_service; ?>" type="text" class="form-control" placeholder="Address 1" style="margin-top: 5px;">
                        <input name="service_address_2_<?php echo $index_service; ?>" type="text" class="form-control" placeholder="Address 2" style="margin-top: 5px;">
                        <div class="form-group" style="margin-top: 5px;margin-bottom: 5px">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="city_billing_customers">
                                        <input name="service_city_<?php echo $index_service; ?>" type="text" class="form-control" placeholder="City"> 
                                    </div>
                                    <div class="space_customers">&nbsp;</div>
                                    <div class="state_billing_customers">
                                        <select name="service_state_<?php echo $index_service; ?>" class="form-control same_as_billing_dis">
                                    ...
                                    <div class="zip_billing_customers">
                                        <input name="service_zip_<?php echo $index_service; ?>" type="text" class="form-control" placeholder="Zip"> 
                                    </div>
                                    <div class="space_customers">&nbsp;</div>
                ...
                <div class=" form-group">
                    ...
                    <div class="col-lg-10 col-md-10 padding_zero">
                        <select name="service_route_<?php echo $index_service; ?>" class="form-control" style="margin-top: 5px;">
