                        ...
                        <div class="col-lg-7 padding_zero">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-10 padding_zero">
                                    <input onchange="Customer_Add.OnChangeBilling()" name="billing_name" type="text" class="form-control" placeholder="Blling Name - Leave blank if same as customer name">
