                                            ...
                                            <?php if(!empty($Service_Item)): ?>
                                                <?php foreach ($Service_Item as $keyItem => $Item): ?>
                                                    ...
                                                    <tr style="background-color:#f1f1f1">
                                                        ...
                                                        <td>
                                                            <input onkeyup="Js_Top.Change_Quantity_Billing(this)" name="lineitems_quantity_<?php echo $index_service; ?>[]" type="text" class="form-control OnlyNumber" value="<?php echo !empty($Item['quantity'])?$Item['quantity']:0 ?>">
                                                        </td>
                                                        <td>
